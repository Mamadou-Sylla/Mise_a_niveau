...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CompetenceFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\GroupeCompetenceFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\GroupeTagFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\NivauFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\ProfilFixtures(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\TagFixtures(), 'groups' => []], 7 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService'))), 'groups' => []]]);
